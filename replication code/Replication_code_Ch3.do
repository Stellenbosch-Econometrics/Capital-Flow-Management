...
teffects psmatch (surge_epiTO) (proliferation vxo_ch money_global_growth lt_rate_us_jp_ea_uk growth_global cont_surge realgdpyoy, noconstant)
tebalance summarize
qui logit proliferation vxo_ch money_global_growth lt_rate_us_jp_ea_uk growth_global cont_surge realgdpyoy, noconstant
predict double ps if e(sample)
tabstat ps, by(proliferation) stats(N min max)

*as suggested by Visconti and Zubizarrt (2018) we trim the dataset (drop some treated observations) in order to increase the overlap 
gen keeper = 1 if ps >= 0.0115173 & ps <= 0.7655102
teffects psmatch (surge_epiTO) (proliferation vxo_ch money_global_growth lt_rate_us_jp_ea_uk growth_global cont_surge realgdpyoy, noconstant) if keeper == 1
teffects psmatch (surge_epiTO) (proliferation vxo_ch money_global_growth lt_rate_us_jp_ea_uk growth_global cont_surge realgdpyoy, noconstant) if keeper == 1 & EM == 0
teffects psmatch (surge_epiTO) (proliferation vxo_ch money_global_growth lt_rate_us_jp_ea_uk growth_global cont_surge realgdpyoy, noconstant) if keeper == 1 & EM == 1
tebalance summarize
